<div class="flex justify-start max-w-full bg-cyan-100 border border-teal-100 rounded-xl">
    <form action="{{ route('vendor.register.submit') }}" method="POST" class="w-full max-w-2xl py-15 px-8">
        ...
        <div class="space-y-5">
            <div>
                <label for="vendor_name" class="block text-sm font-medium text-gray-700 mb-2" value="{{ old('vendor_name') }}">Vendor Name</label>
                <input type="text" name="vendor_name" placeholder="Enter vendor name" value="{{ old('vendor_name') }}" required
            ...
            <div>
                <label for="food_stall" class="block text-sm font-medium text-gray-700 mb-2" value="{{ old('food_stall') }}">Food Stall Name</label>
                <input type="text" name="food_stall" placeholder="Enter food stall name" value="{{ old('food_stall') }}" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition duration-150 placeholder-gray-400">
            </div>

            <div>
                <label for="email" class="block text-sm font-medium text-gray-700 mb-2" value="{{ old('email') }}">Email Address</label>
